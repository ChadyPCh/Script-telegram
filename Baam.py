...
api_id = 7578494       
api_hash = 'e31e479a0e7c605cb0a2ac089c36474a'	
...
client = TelegramClient('Heisemberg11', api_id, api_hash,sequential_updates=True)
...
async def new_quest_handle(event):
 ...
 #arenas
    ...
    if "You met some hostile creatures" in event.raw_text:
        await client.send_message(-1001156688513,event.message) 
...
print(time.asctime(), '-', 'Stared Baam25...')
client.start(phone)
